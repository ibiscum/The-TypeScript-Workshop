...
function toTitleCaseB (input: string) : string {
...
console.log(`toTitleCaseB("war AND peace"):`);
console.log(toTitleCaseB("war AND peace"));

console.log(`toTitleCaseB("Catcher in the Rye"):`);
console.log(toTitleCaseB("Catcher in the Rye"));

console.log(`toTitleCaseB("tO kILL A mOCKINGBIRD"):`);
console.log(toTitleCaseB("tO kILL A mOCKINGBIRD"));

/** ---------- countWords ---------- **/

function countWordsB (input: string) : number {
...
console.log(`countWordsB("War and Peace"):`);
console.log(countWordsB("War and Peace"));

console.log(`countWordsB("catcher-in-the-rye"):`);
console.log(countWordsB("catcher-in-the-rye"));

console.log(`countWordsB("for_whom the-bell-tolls"):`);
console.log(countWordsB("for_whom the-bell-tolls"));

/** ---------- toWords ---------- **/

function toWordsB (input: string) : string[] {
  // split the words using a regex that will match any occurence of
  // a space, underscore or dash characters
  const words = input.split(/[ _-]/);
  return words;
...
console.log(`toWordsB("War and Peace"):`);
console.log(toWordsB("War and Peace"));

console.log(`toWordsB("catcher-in-the-rye"):`);
console.log(toWordsB("catcher-in-the-rye"));

console.log(`toWordsB("for_whom the-bell-tolls"):`);
console.log(toWordsB("for_whom the-bell-tolls"));
